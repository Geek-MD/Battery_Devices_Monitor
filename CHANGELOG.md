...
### Fixed
- Restored backwards compatibility for `total_devices` attribute that was renamed in v1.5.2. Both `total_devices` (deprecated) and `total_monitored_devices` (new) are now available to ensure existing automations continue working.
