...
### Attributes
- `devices_below_threshold`: List of devices with battery below threshold. Each entry contains `name` (device name with area), `area` (area name or empty string), and `battery_level` (percentage)
- `devices_above_threshold`: List of devices with battery above threshold. Each entry contains `name` (device name with area), `area` (area name or empty string), and `battery_level` (percentage)
- `excluded_devices`: List of excluded devices. Each entry contains `name` (device name with area) and `area` (area name or empty string)
...
```json
{
  "devices_below_threshold": [
    {"name": "Temperature Sensor (Kitchen)", "area": "Kitchen", "battery_level": 15},
    {"name": "Remote Control (Living Room)", "area": "Living Room", "battery_level": 18}
  ],
  "devices_above_threshold": [
    {"name": "Motion Sensor (Bedroom)", "area": "Bedroom", "battery_level": 85},
    {"name": "Door Sensor (Hallway)", "area": "Hallway", "battery_level": 92}
  ],
  "excluded_devices": [
    {"name": "Smart Lock (Front Door)", "area": "Front Door"}
  ],
  "total_devices": 4
}
```
